...
class PayView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        params = {
            ...
            # 'server_url': 'http://localhost/create/pay-callback/', # url to callback view
            'result_url': 'http://localhost/create/pay-callback/',
        }
...
#         'version': '3',
#         'result_url': 'http://localhost:8000/create/pay-callback/',
#     })
